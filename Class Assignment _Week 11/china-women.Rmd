...
## Answer 1
  ...
  year1985$teaprod <- ifelse(year1985$teasown > 0 & year1985$orch == 0, 1,0)
  year1985$orchprod <- ifelse(year1985$orch > 0 & year1985$teasown == 0, 1, 0)
...
tea <- est.conf(year1985$sex[year1985$teaprod ==1], conf.level = 0.05)
orch <- est.conf(year1985$sex[year1985$orchprod == 1],conf.level = 0.05)
  ``` 
